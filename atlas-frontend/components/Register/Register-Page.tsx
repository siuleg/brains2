...
export default function RegisterPage() {
    ...
    const [formData, setFormData] = useState({
        ...
        const handleSubmit = async (event: { preventDefault: () => void; }) => {
            ...
            try {
                const response = await fetch('flask-api/register', {
                    method: 'POST',
                    headers: {
                        ...
                        <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form className="space-y-4 md:space-y-4" onSubmit={handleSubmit}>
                                ...
                                <div>
                                    ...
                                    {showAlertSuc && (
                                        <div className=" w-full flex items-center justify-between bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded relative" role="alert">
                                            <div className="flex items-start col-span-11">
                                                <span className="block font-bold sm:inline">Registration Successful Successful! Redirecting to the Dashboard</span>
                                            </div>
                                ...
                                <p className="text-sm text-gray-900 dark:text-gray-400">
                                    <Link href="/login" className="font-medium text-primary-600 hover:underline dark:text-primary-500">Have an account? Login</Link>
                                </p>
                            </form>
                        </div>
                    </div>
