...
import CreateNote from '@/components/Atlas/Create-Note';
  ...
  return (
    <div className = "container max-w-full">
      <div className="w-full flex">
              ...
              <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                  ...
                  {role == "user" && (
                      <>
                          ...
                          <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                              <h1 className="text-white">Notes Functionality</h1>
                              <li>
                                  <Link href="/collections" className="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                                      <svg className="shrink-0 w-5 h-5 text-white-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 950 950">
                                          <path stroke="currentColor" fill="currentColor" d="M192 736h640V128H256a64 64 0 0 0-64 64v544zm64-672h608a32 32 0 0 1 32 32v672a32 32 0 0 1-32 32H160l-32 57.536V192A128 128 0 0 1 256 64z"/>
                                          <path stroke="currentColor" fill="currentColor" d="M240 800a48 48 0 1 0 0 96h592v-96H240zm0-64h656v160a64 64 0 0 1-64 64H240a112 112 0 0 1 0-224zm144-608v250.88l96-76.8 96 76.8V128H384zm-64-64h320v381.44a32 32 0 0 1-51.968 24.96L480 384l-108.032 86.4A32 32 0 0 1 320 445.44V64z"/>
                                      </svg>
        ...
        <div className="ml-56 bg-gray-400 h-screen w-full">
          <p className='font-bold text-5xl p-2 text-black'>Create a New Note</p>
          <div className='pl-6 w-full'>
              <CreateNote onSubmit = {(title, content) => {   
